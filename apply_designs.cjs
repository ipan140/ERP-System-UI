...
const generateTableComponent = (title, endpoint) => `<template>
  <AdminLayout>
...
const configs = [
  { file: 'src/views/Core/Access/UserRoles.vue', title: 'Manajemen Peran (User Roles)', endpoint: '/core/user_roles' },
  { file: 'src/views/Core/Access/Permissions.vue', title: 'Hak Akses (Permissions)', endpoint: '/core/permissions' },
  { file: 'src/views/Core/Communications/Discuss.vue', title: 'Diskusi Internal (Discuss)', endpoint: '/core/discuss' },
  { file: 'src/views/Core/Communications/Mailer.vue', title: 'Kotak Keluar Email (Mailer)', endpoint: '/core/mailer' },
  { file: 'src/views/Core/Communications/Voip.vue', title: 'Riwayat Panggilan (VoIP)', endpoint: '/core/voip' },
  { file: 'src/views/Core/Communications/Whatsapp.vue', title: 'Pesan WhatsApp', endpoint: '/core/whatsapp' },
  { file: 'src/views/Core/Documents/Storage.vue', title: 'Penyimpanan (Storage)', endpoint: '/core/storage' },
  { file: 'src/views/Core/Documents/Documents.vue', title: 'Dokumen Perusahaan', endpoint: '/core/documents' },
  { file: 'src/views/Core/Documents/Report.vue', title: 'Laporan (Reports)', endpoint: '/core/report' },
  { file: 'src/views/Core/Advanced/Knowledge.vue', title: 'Basis Pengetahuan (Knowledge Base)', endpoint: '/core/knowledge' },
  { file: 'src/views/Core/Advanced/Iot.vue', title: 'Perangkat IoT', endpoint: '/core/iot' },
  { file: 'src/views/Core/Advanced/ArtificialIntelligence.vue', title: 'AI Prompts', endpoint: '/artificial_intelligence' } // based on swagger snippet
];

configs.forEach(conf => {
  const filePath = path.join(__dirname, conf.file);
  fs.writeFileSync(filePath, generateTableComponent(conf.title, conf.endpoint));
  console.log(`Updated ${conf.file}`);
});
