  ...
  },
  {
    ...
    items: [
      ...
      { icon: CalenderIcon, name: "Kalender Keuangan", path: "/finance/calendar" },
      {
        ...
        subItems: [
          { name: "Master Bank & Rekanan", path: "/finance/partners", pro: false },
          { name: "Faktur & Tagihan", path: "/finance/invoicing", pro: false },
          { name: "Klaim Pengeluaran", path: "/finance/expenses", pro: false },
          { name: "Bagan Akun (COA) & Kas", path: "/finance/accounting", pro: false },
          { name: "Laporan Keuangan SAK", path: "/finance/reports", pro: false },
          ...
          { name: "Rekonsiliasi Bank", path: "/finance/reconciliation", pro: false },
          { name: "Pajak Indonesia", path: "/finance/tax", pro: false },
          { name: "Aset Tetap & Depresiasi", path: "/finance/assets", pro: false },
          { name: "Kontrol Anggaran", path: "/finance/budget", pro: false },
        ],
      }
    ],
  },
    ...
    items: [
      ...
      { icon: CalenderIcon, name: "Kalender Website", path: "/website/calendar" },
      {
        ...
        subItems: [
          ...
          { name: "Portal Rekanan B2B", path: "/website/partner-portal", pro: false },
          { name: "Whistleblowing (WBS)", path: "/website/whistleblowing", pro: false },
