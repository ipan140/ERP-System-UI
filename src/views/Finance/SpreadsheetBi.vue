...
const fetchData = async () => {
  ...
  try {
    ...
    const res = await fetch(API_BASE_URL + '/finance/spreadsheet_bi', {
...
const saveRecord = async () => {
  ...
  try {
    ...
    const url = isEdit ? API_BASE_URL + '/finance/spreadsheet_bi/' + formData.value.id : API_BASE_URL + '/finance/spreadsheet_bi'
...
const deleteRecord = async (id: number) => {
  ...
  try {
    const token = localStorage.getItem('token')
    const res = await fetch(API_BASE_URL + '/finance/spreadsheet_bi/' + id, {
      method: 'DELETE',
