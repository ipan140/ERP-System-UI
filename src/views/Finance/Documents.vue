...
import { documentsService } from '@/services/finance/documents.service'
import type { IFinanceDocumentDto } from '@/types/finance'

const records = ref<IFinanceDocumentDto[]>([])
...
const formData = ref<IFinanceDocumentDto | any>({ name: '', description: '' })
