...
const fetchData = async () => {
  ...
  try {
    ...
    const res = await fetch(API_BASE_URL + '/supply_chain/manufacturing', {
...
const saveRecord = async () => {
  ...
  try {
    ...
    const url = isEdit ? API_BASE_URL + '/supply_chain/manufacturing/' + formData.value.id : API_BASE_URL + '/supply_chain/manufacturing'
...
const deleteRecord = async (id: number) => {
  ...
  try {
    const token = localStorage.getItem('token')
    const res = await fetch(API_BASE_URL + '/supply_chain/manufacturing/' + id, {
      method: 'DELETE',
