...
const fetchData = async () => {
  ...
  try {
    ...
    const res = await fetch(API_BASE_URL + '/supply_chain/quality', {
...
const saveRecord = async () => {
  ...
  try {
    ...
    const url = isEdit ? API_BASE_URL + '/supply_chain/quality/' + formData.value.id : API_BASE_URL + '/supply_chain/quality'
...
const deleteRecord = async (id: number) => {
  ...
  try {
    const token = localStorage.getItem('token')
    const res = await fetch(API_BASE_URL + '/supply_chain/quality/' + id, {
      method: 'DELETE',
