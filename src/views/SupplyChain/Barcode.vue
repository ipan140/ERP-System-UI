...
const fetchData = async () => {
  ...
  try {
    ...
    const res = await fetch(API_BASE_URL + '/supply_chain/barcode', {
...
const saveRecord = async () => {
  ...
  try {
    ...
    const url = isEdit ? API_BASE_URL + '/supply_chain/barcode/' + formData.value.id : API_BASE_URL + '/supply_chain/barcode'
...
const deleteRecord = async (id: number) => {
  ...
  try {
    const token = localStorage.getItem('token')
    const res = await fetch(API_BASE_URL + '/supply_chain/barcode/' + id, {
      method: 'DELETE',
