...
const fetchData = async () => {
  ...
  try {
    ...
    const res = await fetch(API_BASE_URL + '/sales/point_of_sale', {
...
const saveRecord = async () => {
  ...
  try {
    ...
    const url = isEdit ? API_BASE_URL + '/sales/point_of_sale/' + formData.value.id : API_BASE_URL + '/sales/point_of_sale'
...
const deleteRecord = async (id: number) => {
  ...
  try {
    const token = localStorage.getItem('token')
    const res = await fetch(API_BASE_URL + '/sales/point_of_sale/' + id, {
      method: 'DELETE',
